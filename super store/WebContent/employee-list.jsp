					...
					<div class="panel panel-visible" id="spy3">
						<div class="panel-heading">
							<div class="panel-title hidden-xs">
								<span class="glyphicon glyphicon-tasks"></span>Employee List <span
									style="float: right; margin-right: 20px;"><a
									href="emp-reg.jsp">New Employee</a></span>
							</div>
								...
								<tbody>
									...
									<%
										int cnt = 0;
											PreparedStatement ps = con
													.prepareStatement("select * from employee_master");
									...
									<tr>
										...
										<td><a class="fa fa-edit fa-lg" title="Edit"
											href="emp-edit.jsp?uId=<%=rs.getString("id")%>"><span></span></a>
											<span style="margin-left: 18px;"></span><a
											class="fa fa-trash-o fa-lg" title="Delete"
											onclick="return confirm('Are you sure!?')"
											href="DeleteEmployee?deleteId=<%=rs.getString("id")%>"><span></span></a>
										</td>
										<%
											}
										%>

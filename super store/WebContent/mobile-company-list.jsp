...
<body class="datatables-page" data-spy="scroll" data-target="#nav-spy"
	...
	<div id="main">
		...
		<div class="topbar-right hidden-xs hidden-sm">
			<a href="mobile-company-list.jsp"
					...
					<div class="panel panel-visible" id="spy3">
						<div class="panel-heading">
							<div class="panel-title hidden-xs">
								<span class="glyphicon glyphicon-tasks"></span>Brand List <span
									style="float: right; margin-right: 20px;"><a
									href="add-brand.jsp">New Brand</a></span>
							</div>
						</div>
						<%
							...
							<table class="table table-striped table-hover table-bordered"
								...
								<tbody>
									...
									<tr>
										...
										<td><a
											href="add-brand-categories.jsp?mobId=<%=rs.getString("id")%>">Add
												Mobiles</a></td>
										<td><a class="fa fa-edit fa-lg" title="Edit"
											href="mob-brand-edit.jsp?uId=<%=rs.getString("id")%>"><span></span></a>
											<span style="margin-left: 18px;"></span><a
											class="fa fa-trash-o fa-lg" title="Delete"
											onclick="return confirm('Are you sure!?')"
											href="DeleteBrand?deleteId=<%=rs.getString("id")%>"><span></span></a>
										</td>
										<%
											}
										%>

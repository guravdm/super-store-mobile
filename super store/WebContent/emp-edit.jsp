...
<%
	if (session.getAttribute("userId") != null) {
		...
		session.setAttribute("page", "emp-edit");
		...
		<section id="content_wrapper">
			<header id="topbar" class="ph10">
				...
				<div class="topbar-right hidden-xs hidden-sm">
					...
					</a> <a href="emp-edit.jsp?uId=<%=request.getParameter("uId")%>"
						class="btn btn-default btn-sm light fw600 ml10"> <span
				...
				<div class="tray tray-center">
					<div class="admin-form theme-primary mw1000 center-block"
						...
						<div class="panel heading-border">
							<form method="post" action="employeeUpdate" id="sub_form"
								autocomplete="off">
								<div class="panel-body bg-light">
									<div class="section-divider mt20 mb40">
										<span> Employee Modification</span>
									</div>
									...
									<div class="section row" id="spy1">
										<div class="col-md-12">
											<label for="firstname" class="field prepend-icon"> <input
												value="<%=rs.getString("Name")%>" type="text"
									...
									<input type="hidden" name="loginId" id="loginId"
										value="<%=loginId%>" class="form-control" /> <input
									...
									<div class="section row">
										<div class="col-md-6">
											<label for="username" class="field prepend-icon"> <input
												...
												onkeyup="GetUserNames()"
												value="<%=rs.getString("username")%>"
												class="gui-input phone-group" placeholder="User Name">
										...
										<div class="col-md-6">
											<label for="role" class="field prepend-icon"> <select
												...
												class="select2-single form-control gui-input">
													<option value="<%=rs.getString("role")%>"><%=rs.getString("role")%>
													</option>
									...
									<div class="section row">
										<div class="col-md-6">
											<label for="password" class="field prepend-icon"> <input
												...
												value="<%=rs.getString("password")%>" class="gui-input"
										...
										<div class="col-md-6">
											<label for="repeatPassword" class="field prepend-icon">
												...
												value="<%=rs.getString("password")%>" id="repeatPassword"
												class="gui-input" placeholder="Confirm Password"> <label
									...
									<div class="section row">
										<div class="col-md-6">
											<label for="mobileno" class="field prepend-icon"> <input
												value="<%=rs.getString("mobileno")%>" type="text"
												name="mobileno" id="mobileno" class="gui-input"
									...
									<div class="section" id="spy3">
										...
										</label> <span class="input-footer"> <strong>A
													Addess!:</strong> Use this area to write an address of a Vendor..
										</span>
										</label>
									</div>
